...
exports.swapiResource = (0, core_1.default)((event) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resource = event.pathParameters.resource;
        const queryString = event.rawQueryString;
        const query = event.queryStringParameters;
        const response = yield (0, service_1.getAllResourceSWAPI)(resource, queryString, query);
