...
exports.getResourceSWAPI = void 0;
/* eslint-disable @typescript-eslint/restrict-template-expressions */
const axios_1 = __importDefault(require("axios"));
const config_1 = __importDefault(require("../../config/config"));
const helperTransforObjectSwapi_1 = require("../../helpers/helperTransforObjectSwapi");
const getResourceSWAPI = (params, queryString) => __awaiter(void 0, void 0, void 0, function* () {
    const { resource, id } = params;
    const search = queryString === '' ? '' : `?${queryString}`;
    const { data: swapi } = yield (0, axios_1.default)(`${config_1.default.SWAPI}/${resource}/${id}/${search}`);
